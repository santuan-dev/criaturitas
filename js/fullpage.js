  ...
  (e.fn.fullpage = function (l) {
    ...
    function ve(n) {
      ...
      n
        ...
        : t &&
          (s(Mt.autoScrolling, "internal"),
          Z(Mt.autoScrolling, "internal"),
          e(A).show(),
          lt.removeClass(c),
          e.isFunction(l.afterResponsive) && l.afterResponsive.call(vt, n));
    }
    ...
    function me() {
      ne.on("scroll", Oe).on("hashchange", on).blur(fn).resize(yn),
        te
          .keydown(an)
          .keyup(ln)
    ...
    function Ce() {
      vt.find(l.sectionSelector).addClass(S),
        vt.find(l.slideSelector).addClass(B);
    }
    function Te(e) {
      e
        .find(q)
    ...
    function De(n) {
      ...
      if (!Pe(n.target) && qe(t)) {
        ...
        (zt = r.y),
          (Dt = r.x),
          i.find(q).length && o.abs(Bt - Dt) > o.abs(Rt - zt)
            ? !ut &&
              o.abs(Bt - Dt) > (ne.outerWidth() / 100) * l.touchSensitivity &&
              (Bt > Dt ? bt.m.right && ue(i) : bt.m.left && he(i))
            : l.autoScrolling &&
              St &&
              o.abs(Rt - zt) > (ne.height() / 100) * l.touchSensitivity &&
              (Rt > zt ? Be("down", a) : zt > Rt && Be("up", a));
      }
    }
    function Pe(n, t) {
      t = t || 0;
    ...
    function vn(e) {
      St &&
        (e.pageY < Ft && bt.m.up ? se() : e.pageY > Ft && bt.m.down && ce()),
        (Ft = e.pageY);
    }
    function gn(n, t, o) {
      var i = n.closest(y),
    ...
    function Kn() {
      (ht || pt) &&
        (l.autoScrolling && lt.off(At.touchmove).on(At.touchmove, ze),
        e(r)
          .off(At.touchstart)
          .on(At.touchstart, Fe)
          .off(At.touchmove)
    ...
    function $n(e) {
      ...
      if (l.css3 && l.autoScrolling && !l.scrollBar) {
        ...
        l.autoScrolling && !l.scrollBar ? vt.css("top", -n) : rt.scrollTop(n);
    }
    function _n(e) {
      return {
        "-webkit-transform": e,
    ...
    function nt(n) {
      s(!1, "internal"),
        ...
        clearTimeout(kt),
        clearTimeout(It),
        ne.off("scroll", Oe).off("hashchange", on).off("resize", yn),
        te
    ...
    function tt() {
      $n(0),
        ...
        vt.css({ "-webkit-transition": "none", transition: "none" }),
        rt.scrollTop(0);
      var n = [S, B, F];
